...
data class Book(val title: String, val author: List<Author>, val genre: List<Genre>, val price: Int) {
    constructor(author: Author, title: String, genre: Genre, price: Int) : this(
        title,
        listOf(author),
        listOf(genre),
        price
    ...
    constructor(title: String, author: Author, genre: List<Genre>, price: Int) : this(
        title,
        listOf(author),
        genres,
        price
